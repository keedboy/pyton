...
if artifact_one == True and artifact_two == True and artifact_three == False:
    print('Ты нашел первый и второй артифакт')
if artifact_one == True and artifact_two == False and artifact_three == True:
    print('Ты нашел первый и третий артифакт')
if artifact_one == False and artifact_two == True and artifact_three == True:
    print('Ты нашел второй и третий артифакт')
if artifact_one == False and artifact_two == False and artifact_three == True:
    print('Ты нашел третий артифакт')
if artifact_one == False and artifact_two == True and artifact_three == False:
    print('Ты нашел второй артифакт')
if artifact_one == True and artifact_two == False and artifact_three == False:
    print('Ты нашел первый артифакт')
if artifact_one == False and artifact_two == False and artifact_three == False:
